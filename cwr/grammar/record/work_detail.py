...
alternate = field_special.lineStart + \
            ...
            _factory.get_field('alternate_title') + \
...
entire_title = field_special.lineStart + \
               ...
               _factory.get_field('entire_work_title') + \
               _factory.get_field('iswc') + \
               _factory.get_field('language_code') + \
               _factory.get_field('writer_1_last_name') + \
               _factory.get_field('writer_1_first_name') + \
               _factory.get_field('source') + \
               _factory.get_field('writer_1_ipi_name_n') + \
               _factory.get_field('writer_1_ipi_base_n') + \
               _factory.get_field('writer_2_last_name') + \
               _factory.get_field('writer_2_first_name') + \
               _factory.get_field('writer_2_ipi_name_n') + \
               _factory.get_field('writer_2_ipi_base_n') + \
...
version = field_special.lineStart + \
          ...
          _factory.get_field('original_title') + \
          _factory.get_field('iswc') + \
          _factory.get_field('language_code') + \
          _factory.get_field('writer_1_last_name') + \
          _factory.get_field('writer_1_first_name') + \
...
performing = field_special.lineStart + \
             ...
             _factory.get_field('performing_artist_last_name') + \
             _factory.get_field('performing_artist_first_name') + \
...
recording = field_special.lineStart + \
            ...
            _factory.get_field('first_release_date') + \
            _factory.get_field('constant_1') + \
            _factory.get_field('first_release_duration') + \
            _factory.get_field('constant_2') + \
            _factory.get_field('first_album_title') + \
            _factory.get_field('first_album_label') + \
            _factory.get_field('first_release_catalog_n') + \
            _factory.get_field('ean13') + \
            _factory.get_field('isrc') + \
            _factory.get_field('recording_format') + \
            _factory.get_field('recording_technique') + \
            _factory.get_field('media_type') + \
            field_special.lineEnd

origin = field_special.lineStart + \
         field_record.record_prefix(_config.record_type('work_origin')) + \
         _factory.get_field('intended_purpose') + \
         _factory.get_field('production_title') + \
         _factory.get_field('cd_identifier') + \
         _factory.get_field('cut_number') + \
         _factory.get_field('library') + \
         _factory.get_field('bltvr') + \
         _factory.get_field('visan') + \
         _factory.get_field('production_n') + \
         _factory.get_field('episode_title') + \
         _factory.get_field('episode_n') + \
         _factory.get_field('year_production') + \
         _factory.get_field('audio_visual_key') + \
         field_special.lineEnd

inst_summary = field_special.lineStart + \
               field_record.record_prefix(_config.record_type('instrumentation_summary')) + \
               _factory.get_field('number_voices') + \
               _factory.get_field('standard_instrumentation_type') + \
               _factory.get_field('instrumentation_description') + \
               field_special.lineEnd

inst_detail = field_special.lineStart + \
              field_record.record_prefix(_config.record_type('instrumentation_detail')) + \
              _factory.get_field('instrument') + \
              _factory.get_field('number_players') + \
              field_special.lineEnd

component = field_special.lineStart + \
            field_record.record_prefix(_config.record_type('component')) + \
            _factory.get_field('component_title') + \
            _factory.get_field('iswc') + \
            _factory.get_field('submitter_work_n') + \
            _factory.get_field('component_duration') + \
            _factory.get_field('writer_1_last_name') + \
            _factory.get_field('writer_1_first_name') + \
            _factory.get_field('writer_1_ipi_name_n') + \
            _factory.get_field('writer_2_last_name') + \
